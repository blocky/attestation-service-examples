...
[`bky-as` configuration instructions](https://blocky-docs.redocly.app/attestation-service/{{as-version}}/setup#configuration)
...
[Attestations in the Blocky Attestation Service](https://blocky-docs.redocly.app/attestation-service/{{as-version}}/concepts#attestations-in-the-blocky-attestation-service)
