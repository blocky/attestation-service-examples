...
- Install the Blocky AS CLI by following the
  [setup instructions](https://blocky-docs.redocly.app/v0.1.0-beta.5/attestation-service/setup)
...
[`bky-as` configuration instructions](https://blocky-docs.redocly.app/v0.1.0-beta.5/attestation-service/setup#configuration)
