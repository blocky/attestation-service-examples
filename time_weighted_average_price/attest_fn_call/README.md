...
- Install the Blocky AS CLI by following the
  [setup instructions](https://docs.blocky.rocks/attestation-service/v0.1.0-beta.13/setup)
...
call the`basm` 
[Blocky Attestation Service WASM Go SDK](https://github.com/blocky/basm-go-sdk/tree/v0.1.0-beta.13)
...
[Attestations in the Blocky Attestation Service](https://docs.blocky.rocks/attestation-service/v0.1.0-beta.13/concepts#attestations-in-the-blocky-attestation-service)
