...
[Attestations in the Blocky Attestation Service](https://docs.blocky.rocks/attestation-service/{{{AS_VERSION}}}/concepts#attestations-in-the-blocky-attestation-service)
