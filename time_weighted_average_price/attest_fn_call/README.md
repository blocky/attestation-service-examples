...
[Attestations in the Blocky Attestation Service](https://docs.blocky.rocks/attestation-service/v0.1.0-beta.12/concepts#attestations-in-the-blocky-attestation-service)
